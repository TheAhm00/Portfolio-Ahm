    ...
    <div class="container d-flex align-items-stretch">
      ...
      <div id="content" class="p-4 p-md-5 pt-5">
        ...
        <button style="background: orange; border-color: orange;" type="button" class="btn btn-dark"
          onclick="togglePopUp('portfolio')"> Add
          Project</button>
            ...
            if ($readQuery->num_rows > 0) {
              while ($rd = mysqli_fetch_assoc($readQuery)) {
                ...
                <tr>
                  ...
                  <td><a style="background: orange; border-color: orange;"
                      href="portfolio.php?update=<?php echo "$stdid" ?>&img=<?php echo "$project_img" ?>"
            ...
            <nav aria-label="Page navigation">
              <ul class="pagination">
                ...
                for ($page = 1; $page <= $number_of_pages; $page++) {
                  echo '<li class="page-item"><a href="portfolio.php?page=' . $page . '" class="btn btnn text-white h5 mr-2">' . $page . '</a></li> ';
                }
                ?>
              </ul>
            </nav>
